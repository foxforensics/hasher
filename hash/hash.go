...
import (
	...
	"go.dw1.io/rapidhash"
	"go.foxforensics.eu/go-hash/skein"
	"go.foxforensics.eu/go-hash/streebog"
	"go.foxforensics.eu/go-krypto/has160"
	"go.foxforensics.eu/go-krypto/lsh256"
	"go.foxforensics.eu/go-krypto/lsh512"
	"go.foxforensics.eu/hasher/internal/checksum/kermit"
	"go.foxforensics.eu/hasher/internal/checksum/luhn"
	...
	"go.foxforensics.eu/hasher/internal/unix/bsd"
	"go.foxforensics.eu/hasher/internal/unix/elf"
	"go.foxforensics.eu/hasher/internal/unix/sysv"
	"go.foxforensics.eu/hasher/internal/windows/lm"
	"go.foxforensics.eu/hasher/internal/windows/nt"
	"go.foxforensics.eu/hasher/internal/windows/pe"
